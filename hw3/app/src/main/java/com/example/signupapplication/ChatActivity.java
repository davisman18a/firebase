...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendCloudMessage(chatMessage m) {
        String serverKey = "AAAAumnx5I4:APA91bHhhWm6Y4DQaiTEMuxucfGT1fOn5BLYa2dJZ02PRM_KjjDw8skS754pWbYgySzTAhywass6Ja_qcdkpc0pIgCeFBV1fkR3htcn6iy5pd-F6MabLZtL9i5qrvuHzjouVaWYs_hjp\t\n";
        String topic = "chat";
